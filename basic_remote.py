...
class BasicTab(unittest.TestCase):
	...
	self.driver = webdriver.Remote(command_executor="http://192.168.10.222:5556/wd/hub",desired_capabilities={ "browserName": "firefox", "platform": "LINUX", "node": 5556 })
        self.driver.implicitly_wait(30)
        self.base_url = "http://172.20.4.223/"
